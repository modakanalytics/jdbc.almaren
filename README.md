...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "jdbc-almaren" % "0.0.2-3.1"
```

```
spark-shell --master "local[*]" --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.3-3.1,com.github.music-of-the-ainur:jdbc-almaren_2.12:0.0.2-3.1"
```
## JDBC Batch
